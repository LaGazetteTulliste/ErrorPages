...
<article>
    ...
    <div>
        <p>Désolé pour le désagrément. Nous effectuons actuellement une maintenance. Nous serons de retour sous peu !</p>
        <p>&mdash; L'équipe de LaGazetteTulliste</p>
    </div>
</article>
<script>
    ...
    // Check maintenance every 5 seconds
